...
Route::get('/data/{id}', [DataController::class, 'index'])->name('data.index');
Route::get('/data/{id}/create', [DataController::class, 'create'])->name('data.create');
Route::post('/data/{id}', [DataController::class, 'store'])->name('data.store');
Route::delete('/data/{id}/del', [DataController::class, 'destroy'])->name('data.destroy');
